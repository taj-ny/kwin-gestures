...
| mouse       | *<a href="#device">Device</a>* |                                                                            |         |
| touchpad    | *<a href="#device">Device</a>* |                                                                            |         |
...
| Property         | Type                                   | Description                                   | Default |
|------------------|----------------------------------------|-----------------------------------------------|---------|
| **gestures**     | *list(<a href="#gesture">Gesture</a>)* | Gestures for this device.                     |         |
...
| start_positions    | *list(range(point))*                                 | Where the gesture must be started. Multiple positions can be specified. Currently only supports mouse gestures.<br><br>Points range from 0.0 (0%) to 1.0 (100%). First point is top-left, second is bottom-right.<br><br>Examples:<br>- Right edge: ``0.999;0 - 1;1``<br>- Bottom-left corner: ``0;0.999 - 0.001;1``                |         |
...
| conditions      | *list(<a href="#condition">Condition</a>)*     | Same as *<a href="#gesture">Gesture</a>.conditions*, but only for this action.                                                                                                                                                                                                                                                                                                                                                                                       |         |
...
| name            | *string*                                       | Available in debug logs.                                                                                                                                                                                                                                                                                                                                                                                                                                             |         |
| threshold       | *float* (min) or *range(float)* (min and max)  | Same as *<a href="#gesture">Gesture</a>.threshold*, but only for this action.<br><br>*Begin* actions can't have thresholds.                                                                                                                                                                                                                                                                                                                                          |         |
