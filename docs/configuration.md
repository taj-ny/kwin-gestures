...
| end_positions      | *list(range(point))*                                 | The exact rectangle(s) where the gesture must end. See *begin_positions*.                                                                                                                                                                                                                                                                                                                                                                                |         |
