...
static const std::map<QString, uint32_t> KEY_MAP =
{
...
{
public:
    KeySequenceGestureAction(qreal repeatInterval, std::shared_ptr<VirtualInputDevice> virtualInputDevice, QString sequence);
